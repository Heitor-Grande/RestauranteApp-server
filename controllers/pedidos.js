                        ...
                        if (erro) {
                            ...
                            `, function (erro, produto) {
                                ...
                                if (erro) {
                                    ...
                                    INSERT INTO public.pedido_detalhe
                                    (id_pedido, produto, qtd, valor_und, total, obs, id_cliente, cod_pdv, id_produto)
                                    VALUES(${insert.rows[0].id_pedido}, '${produto.rows[0].nome}', ${req.body.qtde}, ${produto.rows[0].preco}, ${total}, '${req.body.obs}', ${req.params.id_cliente}, '${produto.rows[0].cod_pdv}', ${produto.rows[0].produto})
                                    `, function (erro) {
